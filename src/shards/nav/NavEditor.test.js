...
describe("NavShardEditor", () => {
  it("should render without crashing", () => {
    const wrapper = shallow(<NavEditor sourceObject={sourceObject.toObject()} />);
  ...
  it("can add a `link` item", () => {
    ...
    const wrapper = mount(<NavEditor sourceObject={sourceObject.toObject()} onChange={onChange} />);

    wrapper.find("button.add-link-button").simulate("click");

    expect(onChange.mock.calls[0][0].items.length).toBe(5);
  });
  ...
  it("can update a `link` items `text` value", () => {
    ...
    expect(onChange.mock.calls[0][0].items[0].text).toBe("Overview");
  });
  ...
  it("can update a `link` items `link` value", () => {
    ...
    expect(onChange.mock.calls[0][0].items[0].link).toBe("abc.com");
  });
  ...
  it("can delete a `link` item", () => {
    ...
    expect(onChange.mock.calls[0][0].items.length).toBe(3);
  });

  it("can add an `external` link item", () => {
    const onChange = jest.fn();
    const wrapper = shallow(
      <NavEditor sourceObject={sourceObject.toObject()} onChange={onChange} />
    );

    wrapper.find(".add-external-link-button").simulate("click");
  ...
  it("can change an `external` link items `text` value", () => {
    ...
    expect(onChange.mock.calls[0][0].items[3].text).toBe("Dictionary");
  });
  ...
  it("can change an external link items `link` value", () => {
    ...
    expect(onChange.mock.calls[0][0].items[3].link).toBe("https://dictionary.com");
  });
  ...
  it("can add a symlink item", () => {
    ...
    wrapper.find(".add-symlink-button").simulate("click");
  ...
  it("can change a `symlink` item", () => {
    ...
    expect(onChange.mock.calls[0][0].items[1].id).toBe(1);
  });
  ...
  it("can add a `divider` item", () => {
    ...
    wrapper.find(".add-divider-button").simulate("click");
  ...
  it("can change a `divider` items text value", () => {
    ...
    expect(onChange.mock.calls[0][0].items[2].text).toBe("•");
  });
  ...
  it("can move item up", () => {
    ...
    expect(onChange.mock.calls[0][0].items[1].type).toBe("divider");
  });
  ...
  it("can move item down", () => {
    ...
    expect(onChange.mock.calls[0][0].items[3].type).toBe("divider");
  });
});
